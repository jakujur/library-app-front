        ...
        <div className={"watchlist-book"}>
            ...
            <div className={"watchlist-info"}>
                ...
                <div>
                    ...
                    <button className={"ml-2 p-1 pl-2 pr-2 bg-transparent border-2 border-blue-900 text-blue-900 text-sm rounded-lg hover:bg-blue-900 hover:text-gray-100 focus:border-4 focus:border-blue-900"}><a href={props.book.url} className={"book-link"}
